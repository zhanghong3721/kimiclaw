...
2. **Show a comparison** if you have one (prepare a feature comparison table)
...
**For detailed win-back email sequences**: Design a 3-email post-cancel win-back series (day 7, 30, 60).
...
- [ ] Post-cancel win-back sequence (design a multi-touch email series)
